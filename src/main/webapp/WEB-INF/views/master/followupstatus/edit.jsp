...
<div class="jumbotron">
    <h1 class="display-4 text-center">EDIT FOLLOW UP STATUS</h1>
</div>
<form action="${SITE_URL}/admin/master/enquiries/followup/status/" method="POST">
    ...
    <a class="btn btn-danger float-left mb-3 btn-sm" href="${SITE_URL}/admin/master/enquiries/followup/status"><i class="fa fa-angle-left"></i> Back</a>
</form>
